...
import { generateRandomEmail, generateRandomPassword, generateRandomPhoneNumber, testPostJson, generateTestObjects } from "../helper.js";
...
function LinkEmailTest(baseRoute, userByEmail, userByPhone, doNegativeCase) {
    ...
    isSuccess = check(res, {
        [currentFeature + " correct value should return 200"]: (r) => r.status === 200,
        [currentFeature + " correct value should have Email property"]: (r) => isEqual(r, "data.phone", userByPhone.phone),
